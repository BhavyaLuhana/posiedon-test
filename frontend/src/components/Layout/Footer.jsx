    ...
    <footer className="bg-primary-light pt-12 md:pt-20 pb-5 text-primary-dark">
      <div className="container-custom">
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                ...
                <Link to="/approach" className="text-sm md:text-base text-gray-600 hover:text-primary-dark transition-colors">Approach</Link>
                <div>
                  <div className="text-sm md:text-base text-gray-600 font-medium mb-1 md:mb-2">Plans</div>
                  <div className="space-y-1 md:space-y-2 ml-1 md:ml-2">
                    <Link to="/plans/retail" className="block text-xs md:text-sm text-gray-500 hover:text-primary-dark transition-colors">Retail</Link>
                    <Link to="/plans/corporate" className="block text-xs md:text-sm text-gray-500 hover:text-primary-dark transition-colors">Corporate</Link>
                  </div>
                </div>
                <Link to="/expertise" className="text-sm md:text-base text-gray-600 hover:text-primary-dark transition-colors">Expertise</Link>
                <Link to="/founder" className="text-sm md:text-base text-gray-600 hover:text-primary-dark transition-colors">Founder</Link>
                <Link to="/contact" className="text-sm md:text-base text-gray-600 hover:text-primary-dark transition-colors">Contact</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between text-xs font-semibold pt-6 md:pt-8 border-t border-black/10 gap-3 md:gap-4 text-center md:text-left">
          <div>© 2026 PlanPoseidon Wealth Planners. All Rights Reserved.</div>
