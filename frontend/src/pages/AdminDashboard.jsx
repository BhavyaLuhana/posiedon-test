...
import { getAllClients, deleteClient, approveLead, exportClientsCSV } from '../services/api';
...
const AdminDashboard = () => {
  ...
  const handleExportCSV = async () => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Failed to export CSV. Please try again.');
    } finally {
